...
bool ApplePS2Keyboard::init(OSDictionary * dict)
{
    ...
    parseAction("3b d, 7e d, 7e u, 37 u, 3b u", _actionSwipeUp, countof(_actionSwipeUp));
    parseAction("3b d, 7d d, 7d u, 37 u, 3b u", _actionSwipeDown, countof(_actionSwipeDown));
